 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Modern Framework
 * Plugin URI:        https://github.com/maziyarid/MFW
 * Description:       Advanced AI Content Writer Framework for WordPress
 * Version:           1.0.0
 ...
 * Update URI:        https://github.com/maziyarid/MFW
 */
...
spl_autoload_register(function ($class) {
    ...
    // Build file path
    $file = MFW_PLUGIN_DIR . 'includes/' . $file . '.php';
...
// Start the plugin
add_action('plugins_loaded', __NAMESPACE__ . '\mfw');
// Time constants
